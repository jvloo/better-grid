...
| v1 init API redesign                               | ✓ Shipped     | `mode` presets, `features` registry, `defineColumn`, `useGrid`, `configureBetterGrid`, `context` ref. See `docs/internal/v1-init-api-history.md`. |
...
| MUI theme integration                              | ✓ Shipped     | `docs/guides/theming-with-mui.md` wires palette/typography/density/dark mode           |
